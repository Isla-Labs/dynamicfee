...
deploy-base-sepolia-lib:
	...
	if [ -z "$$EXP_LIB" ] || [ "$$EXP_LIB" = "null" ]; then echo "Error: Deploy ExponentialMathLib first (make deploy-base-sepolia-exp) or set EXP_LIB"; exit 1; fi; \
...
deploy-base-lib:
	...
	if [ -z "$$EXP_LIB" ] || [ "$$EXP_LIB" = "null" ]; then echo "Error: Deploy ExponentialMathLib first (make deploy-base-exp) or set EXP_LIB"; exit 1; fi; \
	echo "ExponentialMathLib: $$EXP_LIB"; \
...
deploy-ethereum-sepolia-lib:
	...
	if [ -z "$$EXP_LIB" ] || [ "$$EXP_LIB" = "null" ]; then echo "Error: Deploy ExponentialMathLib first (make deploy-ethereum-sepolia-exp) or set EXP_LIB"; exit 1; fi; \
	echo "ExponentialMathLib: $$EXP_LIB"; \
...
deploy-ethereum-lib:
	...
	if [ -z "$$EXP_LIB" ] || [ "$$EXP_LIB" = "null" ]; then echo "Error: Deploy ExponentialMathLib first (make deploy-ethereum-exp) or set EXP_LIB"; exit 1; fi; \
	echo "ExponentialMathLib: $$EXP_LIB"; \
